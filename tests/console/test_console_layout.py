...
class TestConsoleLayoutSmoke(unittest.TestCase):
    ...
    def test_collapsed_advanced_is_single_chat_column(self):
        ...
        self.assertIn('id="coreDesk"', text)
        self.assertIn('data-core="read"', text)
        self.assertIn('data-core="write"', text)
        self.assertIn('data-core="git-status"', text)
        self.assertIn('data-core="git-diff"', text)
        self.assertIn('data-core="hive-health"', text)
        self.assertIn('data-core="learn"', text)
