...
=============================
Canonical name: bench_ability.py
Target: C:\\RealAI-clean\\benchmarks/bench_ability.py
...
bench_ability.py never existed. Related recovered: realai/ability_catalog.py.
...
STATUS = "unresolved"
CANONICAL_NAME = "bench_ability.py"
SOURCE_RECOVERED = False
REASON = 'bench_ability.py never existed. Related recovered: realai/ability_catalog.py.'
...
class AbilityBenchmark(BaseBenchmark):
    """Unresolved ability benchmark. Source never present in recovered trees."""
