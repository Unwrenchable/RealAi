...
METADATA = {
    ...
    "game_styles": ["eight_ball", "nine_ball", "ten_ball", "one_pocket", "pyramid"],
    "league_systems": ["apa", "bca", "fargo", "tap", "vnea", "rackup", "roc"],
    "roc": {
        "brand": "ROC — Rack of Champions",
        "formats": ["SINGLES", "SCOTCH_DOUBLES", "SCOTCH_JJ", "TEAMS_5"],
        "ladder": "roc_glicko2",
        "algorithm": "glicko2_v1",
        "display_chip": "{band} • {rating}",
        "display_bands": {
            "Novice": "<400",
        ...
        "defaults": {"rating": 500, "rd": 175, "volatility": 0.06, "min_rd": 30, "tau": 0.5},
        "default_seed": 500,
        "teams_trueskill": False,
        "finalize_order": [
            "league_validate",
            "persist_if_valid",
            "rating_update_per_player",
        ],
        "owns_ledger": False,
        "split_reference_only": "45/35/20 Players Fund / Operator / Platform",
        "money_audit": {
            "abilities": ["ledger_audit", "payout_sanity", "money_anomaly"],
            "read_only": True,
            "authorize_payout": False,
            "gate_before_auto_payout": True,
        },
    },
    "pyramid": {
