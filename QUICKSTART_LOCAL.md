# RealAI Local Quick Reference

> **Canonical Hive stack** (Vulkan `:8080` + orchestrator `:8001`):  
> run `START_HERE.bat` or `start_all.bat` — full map in [`docs/RUN_SERVERS.md`](docs/RUN_SERVERS.md).  
> The `python -m realai.server.app` section below is a **legacy** structured server (often `:8000`), not day-to-day Hive.
...
## Legacy structured server (optional)
