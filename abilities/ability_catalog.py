...
RUNDOWN_ABILITIES: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "status": "PARTIAL",
        "live_path": "POST /v1/tools/execute ability.image_generation (xAI Imagine; needs XAI_API_KEY)",
        "modules": ["abilities/image_generation.py", "realai/providers/xai_media.py", "realai/plugins/atomic_fizz_realai/media/grok_xai.js"],
        "gold_paths": [
    ...
    },
    {
        ...
        "status": "PARTIAL",
        "live_path": "POST /v1/tools/execute ability.video_generation (xAI Imagine Video; needs XAI_API_KEY)",
        "modules": ["abilities/video_generation.py", "realai/providers/xai_media.py", "realai/plugins/atomic_fizz_realai/media/grok_xai.js"],
        "gold_paths": [
            r"C:\Users\tsmit\ATOMIC-FIZZ-CAPS-VAULT-77-WASTELAND-GPS\backend\lib\grok.js",
    ...
    },
    {
        ...
        "status": "PARTIAL",
        "live_path": "POST /v1/tools/execute ability.image_analysis (xAI vision when keyed; else placeholder)",
        "modules": ["abilities/image_analysis.py", "realai/providers/xai_media.py", "core/agents/tools.py"],
    },
    {
        "id": "code_generation",
    ...
    },
    {
        ...
        "status": "PARTIAL",
        "live_path": "POST /v1/audio/transcriptions + ability.audio_transcription (core.voice whisper)",
        "modules": ["abilities/audio_transcription.py", "core/voice/asr_whisper.py", "realai/lambda_embeddings_audio.py"],
    },
    {
        "id": "audio_speech",
        ...
        "status": "PARTIAL",
        "live_path": "POST /v1/audio/speech + ability.audio_speech (core.voice piper)",
    ...
    },
    {
        ...
        "status": "PARTIAL",
        "live_path": "ability.voice_streaming oneshot + apps/api WS /v1/voice",
        "modules": ["abilities/voice_streaming.py", "core/voice", "apps/api/routes/voice_ws.py"],
    },
    {
    ...
    },
    {
        ...
        "live_path": None,
        "modules": [],
        "status_note": "No in-tree hominis modules found after promote/wire scans — remains GOLD archive target",
    },
]
