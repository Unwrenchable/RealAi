"""Nightmare Engine — synthetic organ (first-class hive module)."""
...
class NightmareEngineOrgan(Organ):
    id = "organ.nightmare-engine"
    name = "Nightmare Engine"
    category = "dream"
    description = "Adversarial / failure-mode simulation for safety training"
    capabilities = [
        "adversarial",
        "safety-sim",
    ]
