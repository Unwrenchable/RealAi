"""Lucid Dream Mode — synthetic organ (first-class hive module)."""
...
class LucidDreamModeOrgan(Organ):
    id = "organ.lucid-dream-mode"
    name = "Lucid Dream Mode"
    category = "dream"
    description = "Guided counterfactual simulation under operator control"
    capabilities = [
        "simulate",
        "counterfactual",
    ]
