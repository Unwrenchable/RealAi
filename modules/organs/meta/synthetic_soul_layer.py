"""Synthetic Soul Layer — synthetic organ (first-class hive module)."""
...
class SyntheticSoulLayerOrgan(Organ):
    id = "organ.synthetic-soul-layer"
    name = "Synthetic Soul Layer"
    category = "meta"
    description = "Identity, values, long-horizon purpose (identity.py)"
    capabilities = [
        "identity",
        "values",
        "purpose",
...
def create_organ() -> Organ:
    return SyntheticSoulLayerOrgan()
