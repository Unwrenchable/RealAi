"""Synthetic Creativity Furnace — synthetic organ (first-class hive module)."""
...
class SyntheticCreativityFurnaceOrgan(Organ):
    id = "organ.synthetic-creativity-furnace"
    name = "Synthetic Creativity Furnace"
    category = "meta"
    description = "Divergent generation with controlled novelty"
    capabilities = [
        "creativity",
        "novelty",
    ]
...
def create_organ() -> Organ:
    return SyntheticCreativityFurnaceOrgan()
