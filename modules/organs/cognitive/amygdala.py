"""Amygdala — synthetic organ (first-class hive module)."""
...
class AmygdalaOrgan(Organ):
    id = "organ.amygdala"
    name = "Amygdala"
    category = "cognitive"
    description = "Threat / anomaly salience and safety interrupts"
    capabilities = [
        "threat",
        "salience",
        "interrupt",
