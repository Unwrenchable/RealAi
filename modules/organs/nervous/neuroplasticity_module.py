"""Neuroplasticity Module — synthetic organ (first-class hive module)."""
...
class NeuroplasticityModuleOrgan(Organ):
    id = "organ.neuroplasticity-module"
    name = "Neuroplasticity Module"
    category = "nervous"
    description = "Adapts routing weights from feedback / self-improvement"
    capabilities = [
        "adapt",
        "learn",
        "weights",
...
def create_organ() -> Organ:
    return NeuroplasticityModuleOrgan()
