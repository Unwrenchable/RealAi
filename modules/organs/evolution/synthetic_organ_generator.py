"""Synthetic Organ Generator — synthetic organ (first-class hive module)."""
...
class SyntheticOrganGeneratorOrgan(Organ):
    id = "organ.synthetic-organ-generator"
    name = "Synthetic Organ Generator"
    category = "evolution"
    description = "Scaffolds new organ modules into the hive"
    capabilities = [
        "generate",
        "scaffold",
    ]
...
def create_organ() -> Organ:
    return SyntheticOrganGeneratorOrgan()
