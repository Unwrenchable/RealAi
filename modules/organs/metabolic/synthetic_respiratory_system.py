"""Synthetic Respiratory System — synthetic organ (first-class hive module)."""
...
class SyntheticRespiratorySystemOrgan(Organ):
    id = "organ.synthetic-respiratory-system"
    name = "Synthetic Respiratory System"
    category = "metabolic"
    description = "Streaming breath: chunked token I/O and backpressure"
    capabilities = [
        "stream",
        "backpressure",
    ]
...
def create_organ() -> Organ:
    return SyntheticRespiratorySystemOrgan()
