"""Device Walker Organ — synthetic organ (first-class hive module)."""
...
class DeviceWalkerOrganOrgan(Organ):
    id = "organ.device-walker-organ"
    name = "Device Walker Organ"
    category = "body"
    description = "Filesystem / device traversal under policy sandbox"
    capabilities = [
        "walk",
        "fs",
        "sandbox",
