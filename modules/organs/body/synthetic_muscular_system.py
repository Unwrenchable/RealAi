"""Synthetic Muscular System — synthetic organ (first-class hive module)."""
...
class SyntheticMuscularSystemOrgan(Organ):
    id = "organ.synthetic-muscular-system"
    name = "Synthetic Muscular System"
    category = "body"
    description = "Action actuators: shell, editor, browser tool effectors"
    capabilities = [
        "actuate",
        "effectors",
    ]
...
def create_organ() -> Organ:
    return SyntheticMuscularSystemOrgan()
