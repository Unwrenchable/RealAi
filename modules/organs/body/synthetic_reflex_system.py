"""Synthetic Reflex System — synthetic organ (first-class hive module)."""
...
class SyntheticReflexSystemOrgan(Organ):
    id = "organ.synthetic-reflex-system"
    name = "Synthetic Reflex System"
    category = "body"
    description = "Fast path reflexes for critical safety/tool interrupts"
    capabilities = [
        "reflex",
        "fast-path",
    ]
...
def create_organ() -> Organ:
    return SyntheticReflexSystemOrgan()
