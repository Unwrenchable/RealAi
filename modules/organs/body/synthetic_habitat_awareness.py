"""Synthetic Habitat Awareness — synthetic organ (first-class hive module)."""
...
class SyntheticHabitatAwarenessOrgan(Organ):
    id = "organ.synthetic-habitat-awareness"
    name = "Synthetic Habitat Awareness"
    category = "body"
    description = "Environment/host context (paths, OS, resources)"
    capabilities = [
        "habitat",
        "env",
        "host",
...
def create_organ() -> Organ:
    return SyntheticHabitatAwarenessOrgan()
