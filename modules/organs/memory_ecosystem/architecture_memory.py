"""Architecture Memory — synthetic organ (first-class hive module)."""
...
class ArchitectureMemoryOrgan(Organ):
    id = "organ.architecture-memory"
    name = "Architecture Memory"
    category = "memory_ecosystem"
    description = "System topology, registry map, BRANCH_MAP awareness"
    capabilities = [
        "memory",
        "architecture",
    ]
...
def create_organ() -> Organ:
    return ArchitectureMemoryOrgan()
