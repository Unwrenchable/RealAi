...
class LlamaCliBackend(InferenceBackend):
    ...
    def _find_llama_cli(self) -> Optional[Path]:
        ...
        # Try common local-user install locations on Linux/macOS and Windows
        common_paths = [
            ...
            Path.home() / 'llama.cpp' / 'build' / 'bin' / 'llama-cli.exe',
            Path.home() / 'llama.cpp' / 'llama-cli.exe',
            Path.home() / '.cache' / 'llama.cpp' / 'bin' / 'llama-cli',
            Path.home() / 'tools' / 'llama-cli.exe',
            Path('/usr/local/bin/llama-cli'),
            Path('/usr/local/bin/llama'),
            Path('/opt/llama.cpp/bin/llama-cli'),
            Path('/opt/llama.cpp/bin/llama'),
            Path('/opt/realai/bin/llama-cli'),
            Path('/opt/realai/bin/llama'),
            Path('C:/llama.cpp/llama-cli.exe'),
            Path('C:/llama.cpp/llama-cli'),
            Path('C:/llama.cpp/tools/llama-cli.exe'),
            Path('C:/llama.cpp/tools/llama-cli'),
            Path('C:/llama.cpp/bin/llama-cli.exe'),
            Path('C:/llama.cpp/bin/llama-cli'),
            Path('C:/llama.cpp/build/bin/Release/llama-cli.exe'),
            Path('C:/llama.cpp/build/bin/Release/llama-cli'),
            Path('C:/llama.cpp/build/bin/llama-cli.exe'),
            Path('C:/llama.cpp/build/bin/llama-cli'),
            Path('C:/llama/llama-cli.exe'),
            Path('C:/llama/tools/llama-cli.exe'),
            Path('C:/llama/bin/llama-cli.exe'),
            Path('C:/llama/build/bin/Release/llama-cli.exe'),
            Path('C:/llama/build/bin/llama-cli.exe'),
            Path('C:/Program Files/llama.cpp/llama-cli.exe'),
            Path('C:/Program Files/llama.cpp/tools/llama-cli.exe'),
            Path('C:/Program Files/llama/llama-cli.exe'),
            Path('C:/Program Files/llama/tools/llama-cli.exe'),
            Path('C:/llama-vulkan/llama-cli.exe'),
            Path('C:/llama-vulkan/llama-cli'),
            Path('C:/llama-vulkan/tools/llama-cli.exe'),
            Path('C:/llama-vulkan/tools/llama-cli'),
            Path('C:/llama-vulkan/bin/llama-cli.exe'),
            Path('C:/llama-vulkan/bin/llama-cli'),
            Path('C:/llama-vulkan/build/bin/Release/llama-cli.exe'),
            Path('C:/llama-vulkan/build/bin/Release/llama-cli'),
            Path('C:/llama-vulkan/build/bin/llama-cli.exe'),
            Path('C:/llama-vulkan/build/bin/llama-cli'),
            Path('C:/Program Files/llama-vulkan/llama-cli.exe'),
            Path('C:/Program Files/llama-vulkan/tools/llama-cli.exe'),
            Path('C:/tools/llama-cli.exe'),
        ]
