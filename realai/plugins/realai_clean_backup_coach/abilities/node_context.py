"""Stub ability `node_context` — learned from git-learn (no runtime heal)."""
...
def run(player: dict[str, Any], payload: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "learned": True,
        "heal": False,
        "description": 'Placeholder context hints for node (product owns runtime)',
