"""Stub ability `route_v1_chat_completions` — learned from git-learn (no runtime heal)."""
...
ABILITY_ID = "route_v1_chat_completions"
ALIASES = ()
...
def run(player: dict[str, Any], payload: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "learned": True,
        "heal": False,
        "description": 'Hint stub for discovered route /v1/chat/completions',
