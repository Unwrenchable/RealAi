...
# File lives at realai/plugins/tools/ — product root is parents[3], package root parents[2].
_PKG_ROOT = Path(__file__).resolve().parents[2]  # .../realai
_PRODUCT_ROOT = Path(__file__).resolve().parents[3]  # .../RealAI-clean
for _root in (_PRODUCT_ROOT, _PKG_ROOT):
