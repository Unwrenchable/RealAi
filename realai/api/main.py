...
Live chat still goes through workspace api_server.py (/v1/* + /fusion-ui/).
This app mounts canonical realai.routes via include_all.
"""
...
from apps.api.state import (  # noqa: F401 — side-effect registries
    inference_registry,
    model_cache,
    tool_registry,
    voice_registry,
