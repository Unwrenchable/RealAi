...
def _chat_command(prompt, model, api_url):
    try:
        from realai.bot.boot import coerce_local_model, ensure_bot_registered
...
if click is not None:
    ...
    @click.option('--api-url', envvar='REALAI_API_URL', default='http://127.0.0.1:8001')
    ...
    def main(argv=None):
        ...
        parser.add_argument('--model', default='realai-default-coder')
        parser.add_argument('--api-url', default=os.environ.get('REALAI_API_URL', 'http://127.0.0.1:8001'))
