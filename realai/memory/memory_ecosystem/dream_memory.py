"""Dream Memory — synthetic organ (first-class hive module)."""
...
class DreamMemoryOrgan(Organ):
    id = "organ.dream-memory"
    name = "Dream Memory"
    category = "memory_ecosystem"
    description = "Stores dream/sim outputs for later training"
    capabilities = [
        "memory",
        "dream",
    ]
