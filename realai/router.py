...
class IntelligentRouter:
    ...
    DEFAULT_CAPABILITY_RULES: Dict[str, Dict[str, float]] = {
        ...
        "local": {"chat": 0.95, "code": 0.95, "default": 0.95},
        "realai": {"chat": 0.98, "code": 0.98, "default": 0.98},
    }
    ...
    def __init__(self, routing_rules: Optional[Dict[str, Any]] = None) -> None:
        ...
        self._preference_scores: Dict[str, float] = {"local": 1.0, "realai": 1.0}
    ...
    def select_provider(
        ...
        Returns:
            ...
            Falls back to "local" if no providers are available.
        """
        ...
        return scored[0].provider if scored else "local"
...
def select_realai_bot_provider() -> str:
    """Select provider for RealAI Bot chat — local / realai only."""
