"""Synthetic Inspiration Cortex — synthetic organ (first-class hive module)."""
...
class SyntheticInspirationCortexOrgan(Organ):
    id = "organ.synthetic-inspiration-cortex"
    name = "Synthetic Inspiration Cortex"
    category = "meta"
    description = "Cross-domain analogical idea generation"
    capabilities = [
        "inspiration",
        "analogy",
    ]
...
def create_organ() -> Organ:
    return SyntheticInspirationCortexOrgan()
