"""Cerebellum — synthetic organ (first-class hive module)."""
...
class CerebellumOrgan(Organ):
    id = "organ.cerebellum"
    name = "Cerebellum"
    category = "cognitive"
    description = "Skill fine-tuning, timing, procedural refinement"
    capabilities = [
        "procedural",
        "timing",
        "refine",
