"""Corpus Callosum — synthetic organ (first-class hive module)."""
...
class CorpusCallosumOrgan(Organ):
    id = "organ.corpus-callosum"
    name = "Corpus Callosum"
    category = "cognitive"
    description = "Cross-module routing between agents, tools, providers"
    capabilities = [
        "route",
        "bridge",
        "multiplex",
