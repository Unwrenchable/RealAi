"""Frontal Cortex — synthetic organ (first-class hive module)."""
...
class FrontalCortexOrgan(Organ):
    id = "organ.frontal-cortex"
    name = "Frontal Cortex"
    category = "cognitive"
    description = "Executive planning, goal decomposition, policy selection"
    capabilities = [
        "plan",
        "policy",
        "executive",
