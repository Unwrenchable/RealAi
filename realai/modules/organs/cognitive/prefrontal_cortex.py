"""Prefrontal Cortex — synthetic organ (first-class hive module)."""
...
class PrefrontalCortexOrgan(Organ):
    id = "organ.prefrontal-cortex"
    name = "Prefrontal Cortex"
    category = "cognitive"
    description = "Working-memory control, inhibition, multi-step reasoning"
    capabilities = [
        "reason",
        "inhibit",
        "working-memory",
