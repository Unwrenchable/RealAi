"""Limbic System — synthetic organ (first-class hive module)."""
...
class LimbicSystemOrgan(Organ):
    id = "organ.limbic-system"
    name = "Limbic System"
    category = "cognitive"
    description = "Affective weighting, motivation, reward priors"
    capabilities = [
        "affect",
        "motivation",
    ]
