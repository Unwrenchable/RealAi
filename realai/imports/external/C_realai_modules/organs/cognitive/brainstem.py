"""Brainstem — synthetic organ (first-class hive module)."""
...
class BrainstemOrgan(Organ):
    id = "organ.brainstem"
    name = "Brainstem"
    category = "cognitive"
    description = "Vital loops: heartbeat, health, keep-alive inference"
    capabilities = [
        "health",
        "keepalive",
        "vitals",
