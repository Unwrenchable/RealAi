"""Synthetic Dream Reproductive System — synthetic organ (first-class hive module)."""
...
class SyntheticDreamReproductiveSystemOrgan(Organ):
    id = "organ.synthetic-dream-reproductive-system"
    name = "Synthetic Dream Reproductive System"
    category = "evolution"
    description = "Spawns child scenarios/datasets from dream forge"
    capabilities = [
        "spawn",
        "datasets",
    ]
...
def create_organ() -> Organ:
    return SyntheticDreamReproductiveSystemOrgan()
