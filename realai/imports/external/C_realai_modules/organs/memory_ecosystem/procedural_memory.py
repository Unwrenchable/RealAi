"""Procedural Memory — synthetic organ (first-class hive module)."""
...
class ProceduralMemoryOrgan(Organ):
    id = "organ.procedural-memory"
    name = "Procedural Memory"
    category = "memory_ecosystem"
    description = "Skills, tools, playbooks, procedures"
    capabilities = [
        "memory",
        "procedural",
        "skills",
