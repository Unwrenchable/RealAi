"""Synthetic Circulatory System — synthetic organ (first-class hive module)."""
...
class SyntheticCirculatorySystemOrgan(Organ):
    id = "organ.synthetic-circulatory-system"
    name = "Synthetic Circulatory System"
    category = "metabolic"
    description = "Moves context tokens / embeddings through the pipeline"
    capabilities = [
        "circulate",
        "context",
        "embeddings",
...
def create_organ() -> Organ:
    return SyntheticCirculatorySystemOrgan()
