"""Synthetic Shadow Architect — synthetic organ (first-class hive module)."""
...
class SyntheticShadowArchitectOrgan(Organ):
    id = "organ.synthetic-shadow-architect"
    name = "Synthetic Shadow Architect"
    category = "dream"
    description = "Builds shadow copies of plans for dual-path critique"
    capabilities = [
        "shadow",
        "dual-path",
    ]
...
def create_organ() -> Organ:
    return SyntheticShadowArchitectOrgan()
