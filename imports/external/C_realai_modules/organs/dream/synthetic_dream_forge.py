"""Synthetic Dream Forge — synthetic organ (first-class hive module)."""
...
class SyntheticDreamForgeOrgan(Organ):
    id = "organ.synthetic-dream-forge"
    name = "Synthetic Dream Forge"
    category = "dream"
    description = "Offline synthesis of scenarios for training/eval"
    capabilities = [
        "dream",
        "synthesize",
        "offline",
...
def create_organ() -> Organ:
    return SyntheticDreamForgeOrgan()
