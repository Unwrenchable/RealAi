...
from realai.api_server import RealAIAPIHandler  # noqa: E402
...
def app(environ, start_response):
    ...
    resp_headers.append(("Access-Control-Allow-Headers", "Content-Type, Authorization, X-Provider, X-Base-URL"))
