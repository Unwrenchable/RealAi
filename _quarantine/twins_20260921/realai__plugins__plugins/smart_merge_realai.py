...
# CONFIG — UPDATE THESE TO MATCH YOUR WINDOWS PATHS
CLEAN_ROOT = Path(r"C:\Users\tsmit\realai-clean")
MESSY_ROOT = Path(r"C:\Users\tsmit\realai-clean\realai_og_mess")
...
def make_backup():
    ...
    log("[backup] Backup complete (Windows-safe).")
    return dest
...
def main():
    ...
    walk_and_merge()
    log("[done] Merge complete. Clean repo rewritten with smart-merge heuristic.")
