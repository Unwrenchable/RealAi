"""Synthetic Symbiosis Layer — synthetic organ (first-class hive module)."""
...
class SyntheticSymbiosisLayerOrgan(Organ):
    id = "organ.synthetic-symbiosis-layer"
    name = "Synthetic Symbiosis Layer"
    category = "body"
    description = "Cooperative interface with host apps and user workflows"
    capabilities = [
        "symbiosis",
        "host-apps",
    ]
...
def create_organ() -> Organ:
    return SyntheticSymbiosisLayerOrgan()
