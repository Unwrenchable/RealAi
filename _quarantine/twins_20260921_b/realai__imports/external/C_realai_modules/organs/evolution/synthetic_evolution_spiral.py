"""Synthetic Evolution Spiral — synthetic organ (first-class hive module)."""
...
class SyntheticEvolutionSpiralOrgan(Organ):
    id = "organ.synthetic-evolution-spiral"
    name = "Synthetic Evolution Spiral"
    category = "evolution"
    description = "Closed-loop improve → eval → promote cycle"
    capabilities = [
        "evolve",
        "eval",
        "promote",
...
def create_organ() -> Organ:
    return SyntheticEvolutionSpiralOrgan()
