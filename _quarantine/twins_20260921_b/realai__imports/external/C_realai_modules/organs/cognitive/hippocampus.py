"""Hippocampus — synthetic organ (first-class hive module)."""
...
class HippocampusOrgan(Organ):
    id = "organ.hippocampus"
    name = "Hippocampus"
    category = "cognitive"
    description = "Episodic encode/retrieve bridge into memory engines"
    capabilities = [
        "episodic",
        "encode",
        "retrieve",
