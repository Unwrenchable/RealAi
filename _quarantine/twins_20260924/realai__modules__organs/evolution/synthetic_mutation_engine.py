"""Synthetic Mutation Engine — synthetic organ (first-class hive module)."""
...
class SyntheticMutationEngineOrgan(Organ):
    id = "organ.synthetic-mutation-engine"
    name = "Synthetic Mutation Engine"
    category = "evolution"
    description = "Proposes code/config mutations for self-improvement"
    capabilities = [
        "mutate",
        "propose",
    ]
    hook = "self_improvement"
...
def create_organ() -> Organ:
    return SyntheticMutationEngineOrgan()
