"""Synthetic Paradox Engine — synthetic organ (first-class hive module)."""
...
class SyntheticParadoxEngineOrgan(Organ):
    id = "organ.synthetic-paradox-engine"
    name = "Synthetic Paradox Engine"
    category = "meta"
    description = "Contradiction detection and dual-truth resolution"
    capabilities = [
        "paradox",
        "consistency",
    ]
...
def create_organ() -> Organ:
    return SyntheticParadoxEngineOrgan()
