"""Neural Pathway Builder — synthetic organ (first-class hive module)."""
...
class NeuralPathwayBuilderOrgan(Organ):
    id = "organ.neural-pathway-builder"
    name = "Neural Pathway Builder"
    category = "nervous"
    description = "Wires new tool/agent pathways in the registry"
    capabilities = [
        "wire",
        "pathway",
        "register",
...
def create_organ() -> Organ:
    return NeuralPathwayBuilderOrgan()
