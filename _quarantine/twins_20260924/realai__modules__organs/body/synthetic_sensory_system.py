"""Synthetic Sensory System — synthetic organ (first-class hive module)."""
...
class SyntheticSensorySystemOrgan(Organ):
    id = "organ.synthetic-sensory-system"
    name = "Synthetic Sensory System"
    category = "body"
    description = "Ingest sensors: ASR, files, web, embeddings"
    capabilities = [
        "sense",
        "ingest",
        "asr",
...
def create_organ() -> Organ:
    return SyntheticSensorySystemOrgan()
